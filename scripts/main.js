...
'use strict'; {
    ...
    const HANDLER_CLASS = class VideoDOMHandler extends self.DOMElementHandler {
        constructor(iRuntime) {
            ...
            this.AddDOMElementMessageHandler("set-volume", (elem, e) => this._OnSetVolume(elem,
                e));
        ...
        TryPlayMedia(mediaElem) {
            this._iRuntime.TryPlayMedia(mediaElem);
            if (this._isRuntimeInWorker && this._supportsRvfc &&
                mediaElem["c3_rvfcId"] === -1) mediaElem["c3_rvfcId"] = mediaElem["requestVideoFrameCallback"](() => this._OnVideoFrameCallback(mediaElem))
        }
        RemovePendingPlay(mediaElem) {
            this._iRuntime.RemovePendingPlay(mediaElem);
        ...
        async _OnVideoFrameCallback(mediaElem) {
            ...
            mediaElem["c3_rvfcId"] = mediaElem["requestVideoFrameCallback"](() =>
                this._OnVideoFrameCallback(mediaElem));
            try {
        ...
        CreateElement(elementId, e) {
            ...
            elem.addEventListener("playing", () => this._SendPlaybackEvent(elem, elementId,
                5));
